package ru.lanolin.quote.domain.user.entity;
...
import ru.lanolin.quote.domain.user.entity.Role;
...
public class User implements CommonEntity<UUID> {
    ...
    @ElementCollection(fetch = FetchType.EAGER, targetClass = ru.lanolin.quote.domain.user.entity.Role.class)
